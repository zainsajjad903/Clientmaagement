// src/components/Communication/CommunicationFilters.jsx
...
const CommunicationFilters = ({ filters, onFiltersChange }) => {
  ...
  const hasActiveFilters =
    filters.search || filters.type !== "all" || filters.client !== "all";

  // Mock clients for filter - replace with actual data
  const clients = [
